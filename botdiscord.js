...
if (message.content.startsWith('!bcall')){
 if (message.author.id !== 'NjI2Mjc2MTAxNDU0NTYxMjkw.XYuV6Q.5eSmatnI1AGaulipDnVDCUdSRm4') return message.reply('** هذا الأمر قفط لصاحب البوت و شكراًً **')
 if(!message.author.id === 'NjI2Mjc2MTAxNDU0NTYxMjkw.XYuV6Q.5eSmatnI1AGaulipDnVDCUdSRm4') return;
...
m.sendMessage(args)
 ...
 client.on('message' , function (message){
      var token = 'NjI2Mjc2MTAxNDU0NTYxMjkw.XYuV6Q.5eSmatnI1AGaulipDnVDCUdSRm4'; // التوكن هنا بس
      if(message.content === '!restart') {
if(message.author.id !== 'NjI2Mjc2MTAxNDU0NTYxMjkw.XYuV6Q.5eSmatnI1AGaulipDnVDCUdSRm4') return message.reply('**الامر خاص بـ صاحب البوت وشكرا**');
          client.destroy();
...
if (message.content.startsWith(prefix + `!cat`)) {
            const { body } = await snekfetch.get("https://www.twitch.tv/high_way_stream");
...
client.on("message", message => {
   ...
   if(!message.member.hasPermission('MANAGE_MESSAGES')) return message.reply('⚠ | **ليس لديك صلاحيات**');
      ...
      message.channel.sendMessage("", {embed: {
        ...
        footer: {
          text: "High Way" // غير هنا حط اسم البوت
        }
...
.setFooter(message.author.username, message.author.avatarURL)  
 ...
 client.on('message', message => {
    ...
    client.guilds.get("626276101454561290").members.get("554247389465149450").sendMessage(message.author.tag+"\n Message : "+args)
...
client.on('message', message => {
  ...
  if (message.content.startsWith(adminprefix + 'sets')) {
    client.user.setGame(argresult, "https://www.twitch.tv/high_way_stream");
      message.channel.send(`**✅**`)
  }
...
client.login(NjI2Mjc2MTAxNDU0NTYxMjkw.XYuV6Q.5eSmatnI1AGaulipDnVDCUdSRm4);